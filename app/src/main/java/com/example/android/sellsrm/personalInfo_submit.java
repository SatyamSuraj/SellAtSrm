...
public class personalInfo_submit extends AppCompatActivity {
    ...
    private static final String UPLOAD_URL = "https://geeksofsrm.000webhostapp.com/srmsell/personalAPI.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_personal_info_submit);
    ...
    private void uploadData() {
        ...
        if (memail.getText().toString().isEmpty() || mname.getText().toString().isEmpty() || mcontact.getText().toString().isEmpty() || musername.getText().toString().isEmpty()){
        ...
        try {
            ...
            Intent i = new Intent(personalInfo_submit.this,personalInfo_disp.class);
